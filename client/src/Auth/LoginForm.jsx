...
<div className="relative">
  <label 
    htmlFor="email" 
    className="block w-full h-full cursor-text" // Ajout de cursor-text et de styles pour couvrir toute la zone
  >
    <div className="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
      <Mail className="h-5 w-5 text-indigo-400" />
    </div>
    <input
      id="email" // Ajout d'un id qui correspond au htmlFor du label
      type="email"
      placeholder=" "
      value={email}
...
<div className="relative">
  ...
  >
    ...
    <input
      id="password" // Ajout d'un id qui correspond au htmlFor du label
